...
file_write.write('        <extents>10 10 0.1</extents>\n')
file_write.write('        <diffuseColor>.6 .6 .6</diffuseColor>\n')
file_write.write('      	<ambientColor>0.6 0.6 0.6</ambientColor>\n')
file_write.write('	<Translation>0 0 0</Translation>\n')
...
file_write.write('    <Body type="static">\n')
file_write.write('      <Geom type="box">\n')
file_write.write('        <extents>10 0 10</extents>\n')
